...
public class MatchCheckerTest {
        ...
        @BeforeEach
        void setUp() {
                matchChecker = new MatchChecker(matchmakingService, messagingTemplate, playerProfileRepository,
                                userRepository,
                                matchRepository);
        }
        ...
        void testCheckForMatches_MatchFound() {
                ...
                MatchChecker matchChecker = new MatchChecker(matchmakingService, messagingTemplate,
