...
public class Glicko2RatingTest {

    @Test
    public void testRatingIncreaseAfterWin() {
        // Arrange
    ...
    @Test
    public void testRatingDecreaseAfterLoss() {
        // Arrange
        Glicko2Rating player = new Glicko2Rating(1500, 200, 0.06);
    ...
    @Test
    public void testRatingUnchangedAfterDraw() {
        // Arrange
        Glicko2Rating player = new Glicko2Rating(1500, 200, 0.06);
    ...
    @Test
    public void testRatingDeviationDecrease() {
        // Arrange
        Glicko2Rating player = new Glicko2Rating(1500, 200, 0.06);
    ...
    @Test
    public void testVolatilityWithinBounds() {
        // Arrange
        Glicko2Rating player = new Glicko2Rating(1500, 200, 0.06);
        Glicko2Result result = new Glicko2Result(1500, 200, 0.5);
