...
public class RoundServiceImpl implements RoundService {
    ...
    public void endRound(UUID roundId) {
        ...
        // Set the current round as completed first
    ...
    // I put this here as I can't put it in stageService since it'll cause circular
    // dependencies
    ...
    private void createNextRound(Stage curStage, List<PlayerProfile> advancingPlayers, Round curRound) {
        ...
        // Create new matches for the next round by pairing winners from the current
        // round
