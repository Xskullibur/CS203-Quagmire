    ...
    useEffect(() => {
        const fetchTournamentDetails = async () => {
            ...
            try {
                ...
                // console.log(registeredResponse.data[0]);
                
                const isRegistered = registeredResponse.data.some((player: { user: User }) => {
                ...
                // setRegistered(registeredResponse.data.some((player: { user: User }) => player.user.userId === userId));
