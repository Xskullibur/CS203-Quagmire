...
import { ChevronLeftIcon, ChevronRightIcon, FilePenIcon, LockKeyholeIcon, UnlockKeyholeIcon } from "lucide-react";
                    ...
                    {users.map((user) => (
                        <TableRow key={user.userId}>
                            ...
                            {/* <TableCell className="2xl:space-x-4 sm:space-y-2">
                                ...
                                <Button variant="destructive" size="icon" onClick={() => onLock(user, !user.isLocked)}>
                                    {
                                        user.isLocked ?
